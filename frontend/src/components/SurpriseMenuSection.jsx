...
import girlImg from "../assets/girl-chicken-img.png";

const items = [
  { name: "Zakoota Signature Burger", desc: "BURGERS.", price: "$14.00" },
  {
    name: "Crispy Tenders",
    desc: "Crispy New York Chicken Tenders.",
    price: "$9.99",
  },
  {
    name: "NYC Feather Bread Chicken Roll",
    desc: "Kebab Rolls.",
    price: "$12.00",
  },
  { name: "Peri Peri Sauce", desc: "Sauces.", price: "$3.99" },
  {
    name: "Zakoota Southern Fries",
    desc: "Crispy New York Chicken Tenders.",
    price: "$4.48",
  },
];
