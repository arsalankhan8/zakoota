...
const timelineData = [
  {
    ...
    text: `It all started with a dream and a $500 loan. Tom and James Monaghan purchased a small pizza shop called "DomiNick's" in Ypsilanti, Michigan, laying the foundation for what would become a global culinary icon.`,
    image: firstImg,
    side: "right",
  },
  {
    year: "1990",
    title: "Flavor",
    heading: "MASTERING THE CRAFT",
    text: `Quality became our obsession. By 1990, we perfected our signature recipes—balancing fresh ingredients with bold new flavors to ensure every bite was a "Wonderful Food" experience for our growing community.`,
    image: secondImg,
    side: "left",
  },
  {
    year: "2005",
    title: "Growth",
    heading: "A GLOBAL PHENOMENON",
    text: `From local favorite to international household name. In 2005, we crossed borders and oceans, opening hundreds of stores worldwide and sharing our passion for great food with millions of new friends.`,
    image: thirdImg,
    side: "right",
  },
  {
    ...
    text: `We aren't just feeding the present; we're fueling the future. By integrating sustainable practices and cutting-edge kitchen technology, we’ve reshaped the dining experience for a modern, digital world.`,
    image: fourthImg,
    side: "left",
  },
];
